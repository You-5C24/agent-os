...
export const CLAUDE_REQUEST_APPROVAL_TOOL_NAME = `mcp__agent_os__${REQUEST_APPROVAL_TOOL_NAME}`;
export const CLAUDE_SCHEDULE_MANAGE_TOOL_NAME = `mcp__agent_os__${SCHEDULE_MANAGE_TOOL_NAME}`;
